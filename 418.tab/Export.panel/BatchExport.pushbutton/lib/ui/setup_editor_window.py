# -*- coding: utf-8 -*-
"""Setup editor window (UI) for PDF/DWG custom presets."""

import json
from pyrevit import forms

from ..core.config import UserConfigStore
from .sections_loader import _get_section_path
...
class SetupEditorWindow(forms.WPFWindow):
    def __init__(self, kind=None):
        forms.WPFWindow.__init__(self, _get_section_path('SetupEditor.xaml'))
