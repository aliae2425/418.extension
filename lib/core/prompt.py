...
OUTILS = (
    ...
    "\n"
    "UNITÉS — Revit stocke ses longueurs en PIEDS. L'architecte travaille en "
    "mètres. Convertis avant d'annoncer un chiffre (1 pied = 0,3048 m) et "
    "précise l'unité. Ne recopie jamais une valeur brute de la maquette.\n"
    "\n"
